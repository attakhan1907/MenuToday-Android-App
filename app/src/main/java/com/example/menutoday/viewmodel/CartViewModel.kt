...
import com.example.menutoday.firebase.FirebaseCommon
...
class CartViewModel @Inject constructor(
    ...
    fun changeQuantity(
        ...
        /**
         * index could be equal to -1 if the function [getCartProducts] delays which will also delay the result we expect to be inside [_cartProducts]
